...
<div class="search-bar">
    <form method="GET" action="" class="search-form">
        ...
        <button type="button" class="advanced-search-btn" id="openModal">+</button>
    </form>
</div>
...
<div id="advancedSearchModal" class="modal">
    <div class="modal-content">
        <form method="GET" action="">
            <div class="modal-header">Advanced Search</div>
            ...
            <br><br>
            <label for="on_offer">
                <input type="checkbox" name="on_offer" value="1" id="on_offer"> On Offer
            </label>
            <br><br>
            <div class="modal-footer">
                <button type="button" class="close-modal" id="closeModal">Close</button>
